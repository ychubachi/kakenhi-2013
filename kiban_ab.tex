...
\newcommand{\研究代表者氏名ふりがな}{ゆかわ　ひでき}
\newcommand{\me}{\underline{\underline{H.~Yukawa}}}

%---- 本研究への研究代表者のエフォート（％）
\newcommand{\本応募effort}{\KLEffort{44}}	% 半角数字のみ
...
%begin  研究目的概要＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
    ...
    そんなことはできるわけない。きっとできない。EGitインストール。
%end  研究目的概要 ＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
}
...
\newcommand{\本人の研究経費}{%
%begin  本人の研究経費 ＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
	\KLMyBudget{1111}{9999}% 初年度と、期間全体で「本人が」使う額
...
%begin  応募中の研究費　＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
		...
		基盤研究(D) (一般)・ H19$\sim$H23
			& キリンの卵
			& 代表
			& \KLMyBudget{12345}{67890}% 初年度と、期間全体で「本人が」使う額
			& \KLEffort{20}
			& キリンと象の体系の違いから、卵の力学的性質が異なると考えられる。
			　（総額：999,999千円)
			\\
		\hline
		基盤研究 (C) (一般)・H19$\sim$H23
			& カバの卵（朝永振一郎）
			& 分担
			& \KLMyBudget{123}{456}% 初年度と、期間全体で「本人が」使う額
			& \KLEffort{12}
			& カバの卵は浮力を利用でき、象の卵とは異なる淘汰圧を受けていると予想される
			\\
		\hline
...
%begin  受け入れ予定の研究費　＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
		科学研究費補助金・萌芽研究・H19$\sim$H23
			& カンガルーの卵（最上秀樹）
			& 分担
			& \KLMyBudget{1234}{5678}% 初年度と、期間全体で「本人が」使う額
			& \KLEffort{21}
			& カンガルーは有胎類であり、カモノハシとの系統
                        	関係からするとあの袋に卵を隠している可能性がある
			\\
		\hline
%		\multicolumn{6}{c}{\dotfill} \\
%end  受け入れ予定の研究費　＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
